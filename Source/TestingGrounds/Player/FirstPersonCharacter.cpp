...
void AFirstPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	// Bind fire events
	// Created seperate function to include code in BeginPlay
	SetupFireInput();
...
void AFirstPersonCharacter::SetupFireInput()
{
	if (!PlayerInputComp) { return; }
	// Bind fire event
	PlayerInputComp->BindAction("Fire", IE_Pressed, Gun, &AGun::OnFire);
}
